                                ...
                                <div class="swiper-wrapper">
                                    @foreach($slide_posts as $post)
                                        <div class="swiper-slide">
                                            <a href="{{route('show-post', $post->id)}}" class="img-bg d-flex align-items-end" style="background-image: url('{{asset('storage/'. $post->image)}}');">
                        ...
                        <div class="col-lg-4">
                            <div class="post-entry-1 lg">
                                ...
                                <div class="d-flex align-items-center author">
                                    <div class="photo"><img src="{{asset('storage/'.$latest_post->image)}}" alt="" class="img-fluid"></div>
                                    <div class="name">
                                        <h3 class="m-0 p-0">{{$latest_post->user->name}}</h3>
                                    </div>
                                </div>
                            </div>
